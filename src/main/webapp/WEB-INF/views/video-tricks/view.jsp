...
<head>
    ...
    <title>${videoTrick.title} - Video Trick Detail</title>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="${pageContext.request.contextPath}/video-tricks">Video Tricks</a>
                    </li>
        ...
        <div class="col-lg-8">
            <div class="video-info p-4 mb-4">
                ...
                <div class="d-flex justify-content-between align-items-start mb-3">
                    <h1 class="h3 mb-0">${videoTrick.title}</h1>
                ...
                <!-- Video URL -->
                <div class="mb-3">
                    <h6><i class="fas fa-link me-2"></i>Video Link</h6>
        ...
        <div class="col-lg-4">
            ...
            <div class="card info-card mb-4">
                <div class="card-header bg-transparent border-0">
                    <h5 class="mb-0">
                        <i class="fas fa-info me-2"></i>Video Information
                    </h5>
                </div>
                <div class="card-body">
                    <div class="row g-3">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header"><h5 class="modal-title"><i
                    class="fas fa-exclamation-triangle text-danger me-2"></i> Confirm Delete </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body">
                <div class="text-center"><i class="fas fa-trash-alt fa-3x text-danger mb-3"></i> <h5>Are you sure you
                    want to delete this video trick?</h5>
                    <p class="text-muted">"<strong>${videoTrick.title}</strong>"</p>
                    <div class="alert alert-warning"><i class="fas fa-exclamation-triangle me-2"></i> This action cannot
                        be undone!
                    </div>
                </div>
            </div>
            <div class="modal-footer justify-content-center">
                ...
                <a href="${pageContext.request.contextPath}/video-tricks?action=delete&id=${videoTrick.id}"
                   class="btn btn-danger"> <i class="fas fa-trash me-2"></i>Delete Now </a></div>
        </div>
    </div>
</div> <!-- Toast for copy notification -->
<div class="toast-container position-fixed bottom-0 end-0 p-3">
    <div id="copyToast" class="toast" role="alert">
        <div class="toast-header"><i class="fas fa-check-circle text-success me-2"></i> <strong
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (thumbnail) {
            thumbnail.addEventListener('error', function () {
                ...
                parent.innerHTML = ` <div class="bg-secondary text-white d-flex align-items-center justify-content-center" style="height: 300px; border-radius: 12px;"> <div class="text-center"> <i class="fas fa-image fa-3x mb-3"></i> <h5>Thumbnail Unavailable</h5> <p class="mb-0">Unable to load image</p> </div> </div> `;
            });
        }
    });
</script>
