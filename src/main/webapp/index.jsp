    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
                ...
                <p class="lead mb-4">A rich video library with thousands of tutorials on magic, tricks, and unique skills.</p>
...
<section class="bg-light py-5">
    <div class="container">
        ...
        <div class="row g-3 justify-content-center">
            <div class="col-md-3">
                <a href="${pageContext.request.contextPath}/video-tricks?action=add" class="btn btn-primary w-100 py-3">
                    <i class="fas fa-plus fa-lg"></i><br>
                    <small>Add New Video</small>
                </a>
            </div>
            <div class="col-md-3">
                <a href="${pageContext.request.contextPath}/categories?action=add" class="btn btn-success w-100 py-3">
